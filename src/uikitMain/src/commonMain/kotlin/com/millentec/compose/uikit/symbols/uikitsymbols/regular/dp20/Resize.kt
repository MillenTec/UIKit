...
val UIKitSymbols.Resize: ImageVector
    get() {
        if (_Resize != null) {
            return _Resize!!
        }
        _Resize = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF1D1D1F))) {
                ...
                horizontalLineTo(14.5f)
                curveTo(15.881f, 17f, 17f, 15.881f, 17f, 14.5f)
                ...
                curveTo(7.026f, 16f, 7.25f, 16.224f, 7.25f, 16.5f)
                curveTo(7.25f, 16.776f, 7.026f, 17f, 6.75f, 17f)
                horizontalLineTo(5.5f)
                curveTo(4.119f, 17f, 3f, 15.881f, 3f, 14.5f)
                verticalLineTo(13.25f)
                curveTo(3f, 12.974f, 3.224f, 12.75f, 3.5f, 12.75f)
                curveTo(3.776f, 12.75f, 4f, 12.974f, 4f, 13.25f)
                verticalLineTo(14.5f)
                close()
                moveTo(6.5f, 5f)
                ...
                verticalLineTo(13.5f)
                curveTo(14f, 13.776f, 13.776f, 14f, 13.5f, 14f)
                horizontalLineTo(6.5f)
