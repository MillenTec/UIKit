            ...
            override fun colorSet(
                ...
                return UIKitSymbolColorSet(
                    ...
                    layerInfo = listOf(
                        ...
                        Pair("wave1", if (disabled) 0.6f else 0.6f),
                        Pair("wave2", if (disabled) 0.6f else 0.45f),
                        Pair("mute", 0.6f),
                        Pair("disable", 1f)
                    ),
                    multiColor = listOf(
                        UIKitSymbolColor("speaker", UIKitBrush.solid(if (disabled) getUIKitColors().lineFillColorDisabled else getUIKitColors().highlightColorPrimaryBrush), 1f),
                        UIKitSymbolColor("mute", UIKitBrush.solid(if (disabled) getUIKitColors().lineFillColorDisabled else getUIKitColors().highlightColorPrimaryBrush), 1f),
                        UIKitSymbolColor("disable", UIKitBrush.solid(getUIKitColors().highlightColorPrimaryBrush), 1f),
                        UIKitSymbolColor(
                            selector = "wave0",
                            brush = UIKitBrush.solid(if (disabled) getUIKitColors().lineFillColorDisabled else getUIKitColors().highlightColorPrimaryBrush),
                            alpha = 1f
                        ),
                        UIKitSymbolColor(
                            selector = "wave1",
