...
val FluentIcons.TransportationTruck: ImageVector
    get() {
        if (_TransportationTruck != null) {
            return _TransportationTruck!!
        }
        _TransportationTruck = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(10.05f, 15f)
                curveTo(10.282f, 13.859f, 11.291f, 13f, 12.5f, 13f)
                curveTo(12.672f, 13f, 12.839f, 13.017f, 13f, 13.05f)
                verticalLineTo(4.75f)
                curveTo(13f, 4.336f, 12.665f, 4f, 12.25f, 4f)
                horizontalLineTo(3.792f)
                curveTo(3.378f, 4f, 3.042f, 4.336f, 3.042f, 4.75f)
                verticalLineTo(14.25f)
                curveTo(3.042f, 14.664f, 3.378f, 15f, 3.792f, 15f)
                horizontalLineTo(4.05f)
                curveTo(4.282f, 13.859f, 5.291f, 13f, 6.5f, 13f)
                curveTo(7.71f, 13f, 8.719f, 13.859f, 8.95f, 15f)
                horizontalLineTo(10.05f)
                close()
                moveTo(14f, 13.5f)
                curveTo(14.481f, 13.86f, 14.827f, 14.39f, 14.95f, 15f)
                horizontalLineTo(16.501f)
                curveTo(16.777f, 15f, 17.001f, 14.776f, 17.001f, 14.5f)
                verticalLineTo(11f)
...
private var _TransportationTruck: ImageVector? = null
