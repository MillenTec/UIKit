...
val FluentIcons.Settings: ImageVector
    get() {
        if (_Settings != null) {
            return _Settings!!
        }
        _Settings = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF1D1D1F))) {
                ...
                close()
                moveTo(2.972f, 7.377f)
                lineTo(4.265f, 8.475f)
                curveTo(4.348f, 8.546f, 4.425f, 8.623f, 4.495f, 8.705f)
                curveTo(5.21f, 9.547f, 5.107f, 10.81f, 4.265f, 11.525f)
                lineTo(2.972f, 12.623f)
                curveTo(3.264f, 13.405f, 3.685f, 14.132f, 4.216f, 14.775f)
                lineTo(5.812f, 14.204f)
                curveTo(5.915f, 14.168f, 6.02f, 14.14f, 6.127f, 14.12f)
                curveTo(7.213f, 13.922f, 8.255f, 14.642f, 8.453f, 15.729f)
                lineTo(8.757f, 17.397f)
                curveTo(9.165f, 17.465f, 9.58f, 17.5f, 10f, 17.5f)
                curveTo(10.42f, 17.5f, 10.835f, 17.466f, 11.243f, 17.398f)
                lineTo(11.547f, 15.729f)
                curveTo(11.567f, 15.622f, 11.595f, 15.517f, 11.632f, 15.415f)
                curveTo(12.003f, 14.375f, 13.148f, 13.833f, 14.188f, 14.204f)
                lineTo(15.784f, 14.775f)
                curveTo(16.316f, 14.132f, 16.737f, 13.405f, 17.029f, 12.623f)
                lineTo(15.735f, 11.524f)
                curveTo(15.653f, 11.454f, 15.576f, 11.377f, 15.505f, 11.295f)
                curveTo(14.79f, 10.453f, 14.893f, 9.19f, 15.735f, 8.475f)
                lineTo(17.029f, 7.377f)
                curveTo(16.737f, 6.595f, 16.316f, 5.868f, 15.784f, 5.225f)
                lineTo(14.188f, 5.796f)
                curveTo(14.086f, 5.832f, 13.981f, 5.86f, 13.874f, 5.88f)
                curveTo(12.787f, 6.078f, 11.746f, 5.358f, 11.547f, 4.271f)
                lineTo(11.243f, 2.602f)
                curveTo(10.835f, 2.534f, 10.42f, 2.5f, 10f, 2.5f)
                curveTo(9.58f, 2.5f, 9.165f, 2.534f, 8.757f, 2.602f)
                lineTo(8.453f, 4.271f)
                curveTo(8.434f, 4.378f, 8.405f, 4.483f, 8.369f, 4.585f)
                curveTo(7.997f, 5.625f, 6.853f, 6.167f, 5.812f, 5.796f)
                lineTo(4.216f, 5.225f)
                curveTo(3.685f, 5.868f, 3.264f, 6.595f, 2.972f, 7.377f)
                close()
                moveTo(7.5f, 10f)
                curveTo(7.5f, 8.619f, 8.62f, 7.5f, 10f, 7.5f)
                curveTo(11.381f, 7.5f, 12.5f, 8.619f, 12.5f, 10f)
                curveTo(12.5f, 11.381f, 11.381f, 12.5f, 10f, 12.5f)
                curveTo(8.62f, 12.5f, 7.5f, 11.381f, 7.5f, 10f)
                close()
                moveTo(8.5f, 10f)
                curveTo(8.5f, 10.828f, 9.172f, 11.5f, 10f, 11.5f)
                curveTo(10.829f, 11.5f, 11.5f, 10.828f, 11.5f, 10f)
                curveTo(11.5f, 9.172f, 10.829f, 8.5f, 10f, 8.5f)
                curveTo(9.172f, 8.5f, 8.5f, 9.172f, 8.5f, 10f)
                close()
            }
        }.build()
