...
val UIKitSymbols.Filled.TransportationMotorcycle: ImageVector
    get() {
        if (_TransportationMotorcycle != null) {
            return _TransportationMotorcycle!!
        }
        _TransportationMotorcycle = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(10.028f, 7f, 8.816f, 7.749f, 8.224f, 8.935f)
                lineTo(7.691f, 10f)
                horizontalLineTo(4f)
                curveTo(2.343f, 10f, 1f, 11.343f, 1f, 13f)
                curveTo(1f, 14.657f, 2.343f, 16f, 4f, 16f)
                curveTo(5.306f, 16f, 6.418f, 15.165f, 6.829f, 14f)
                horizontalLineTo(8.764f)
                curveTo(9.639f, 14f, 10.445f, 13.543f, 10.896f, 12.805f)
                curveTo(10.924f, 12.77f, 10.946f, 12.731f, 10.963f, 12.689f)
                curveTo(10.976f, 12.665f, 10.988f, 12.642f, 11f, 12.618f)
                lineTo(11.309f, 12f)
                lineTo(6.829f, 12f)
                curveTo(6.698f, 11.627f, 6.494f, 11.288f, 6.236f, 11f)
...
private var _TransportationMotorcycle: ImageVector? = null
