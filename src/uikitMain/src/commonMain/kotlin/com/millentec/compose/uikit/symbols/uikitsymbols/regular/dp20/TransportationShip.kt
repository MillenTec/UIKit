...
fun UIKitSymbols.transportationShip(
    primary: Brush,
    secondary: Brush
): ImageVector {
    return ImageVector.Builder(
        ...
        path(fill = primary) {
            moveTo(7.5f, 2.039f)
            curveTo(7.224f, 2.039f, 7f, 2.263f, 7f, 2.539f)
            verticalLineTo(5.001f)
            horizontalLineTo(4.5f)
            curveTo(4.224f, 5.001f, 4f, 5.224f, 4f, 5.501f)
            verticalLineTo(9.563f)
            lineTo(2.366f, 10.019f)
            curveTo(2.224f, 10.058f, 2.107f, 10.158f, 2.045f, 10.292f)
            curveTo(1.984f, 10.426f, 1.985f, 10.58f, 2.048f, 10.713f)
            lineTo(3.85f, 14.542f)
            curveTo(4.067f, 14.281f, 4.371f, 14.096f, 4.713f, 14.029f)
            lineTo(3.204f, 10.823f)
            lineTo(9.459f, 9.079f)
            curveTo(9.811f, 8.981f, 10.182f, 8.981f, 10.533f, 9.079f)
            lineTo(16.79f, 10.822f)
            lineTo(15.25f, 14.021f)
            curveTo(15.594f, 14.078f, 15.901f, 14.252f, 16.126f, 14.505f)
            lineTo(17.951f, 10.717f)
            curveTo(18.015f, 10.584f, 18.017f, 10.429f, 17.955f, 10.294f)
            curveTo(17.894f, 10.159f, 17.777f, 10.058f, 17.634f, 10.019f)
            lineTo(16f, 9.564f)
            verticalLineTo(5.501f)
            curveTo(16f, 5.224f, 15.776f, 5.001f, 15.5f, 5.001f)
            horizontalLineTo(13f)
            verticalLineTo(2.539f)
            curveTo(13f, 2.263f, 12.776f, 2.039f, 12.5f, 2.039f)
            ...
            close()
            moveTo(15f, 6.001f)
            verticalLineTo(9.285f)
            lineTo(10.801f, 8.116f)
            curveTo(10.274f, 7.969f, 9.718f, 7.969f, 9.191f, 8.116f)
            lineTo(5f, 9.284f)
...
fun UIKitSymbols.transportationShip(): ImageVector {
    return transportationShip(
