...
val FluentIcons.Filled.Tools: ImageVector
    get() {
        if (_Tools != null) {
            return _Tools!!
        }
        _Tools = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF1D1D1F))) {
                ...
                verticalLineTo(13f)
                close()
                moveTo(5.779f, 2.126f)
                curveTo(5.917f, 2.219f, 6f, 2.375f, 6f, 2.541f)
                verticalLineTo(5.998f)
                curveTo(6f, 6.55f, 6.448f, 6.998f, 7f, 6.998f)
                curveTo(7.552f, 6.998f, 8f, 6.55f, 8f, 5.998f)
                verticalLineTo(2.541f)
                curveTo(8f, 2.375f, 8.083f, 2.219f, 8.221f, 2.126f)
                curveTo(8.358f, 2.033f, 8.533f, 2.015f, 8.688f, 2.078f)
                curveTo(10.336f, 2.745f, 11.5f, 4.361f, 11.5f, 6.25f)
                curveTo(11.5f, 8.018f, 10.481f, 9.546f, 9f, 10.282f)
                verticalLineTo(15.998f)
                curveTo(9f, 17.103f, 8.105f, 17.998f, 7f, 17.998f)
                curveTo(5.895f, 17.998f, 5f, 17.103f, 5f, 15.998f)
                verticalLineTo(10.282f)
                curveTo(3.519f, 9.546f, 2.5f, 8.018f, 2.5f, 6.25f)
                curveTo(2.5f, 4.361f, 3.664f, 2.745f, 5.312f, 2.078f)
                curveTo(5.467f, 2.015f, 5.642f, 2.033f, 5.779f, 2.126f)
                close()
            }
        }.build()
