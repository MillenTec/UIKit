...
val UIKitSymbols.TransportationSubway: ImageVector
    get() {
        if (_TransportationSubway != null) {
            return _TransportationSubway!!
        }
        _TransportationSubway = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                moveTo(8f, 14f)
                curveTo(8f, 14.552f, 7.553f, 15f, 7f, 15f)
                curveTo(6.448f, 15f, 6f, 14.552f, 6f, 14f)
                curveTo(6f, 13.448f, 6.448f, 13f, 7f, 13f)
                curveTo(7.553f, 13f, 8f, 13.448f, 8f, 14f)
                close()
                moveTo(13f, 15f)
                ...
                horizontalLineTo(4f)
                verticalLineTo(14f)
                curveTo(4f, 15.105f, 4.896f, 16f, 6f, 16f)
                horizontalLineTo(7.989f)
                curveTo(7.996f, 16f, 8.004f, 16f, 8.011f, 16f)
                horizontalLineTo(11.99f)
                curveTo(11.997f, 16f, 12.004f, 16f, 12.012f, 16f)
                close()
                moveTo(4f, 6f)
                verticalLineTo(11f)
...
private var _TransportationSubway: ImageVector? = null
