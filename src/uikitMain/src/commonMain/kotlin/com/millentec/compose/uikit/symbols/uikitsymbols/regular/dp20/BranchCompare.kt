...
val UIKitSymbols.BranchCompare: ImageVector
    get() {
        ...
        _BranchCompare = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF1D1D1F))) {
                ...
                curveTo(13.895f, 17f, 13f, 16.105f, 13f, 15f)
                curveTo(13f, 13.895f, 13.895f, 13f, 15f, 13f)
                curveTo(16.105f, 13f, 17f, 13.895f, 17f, 15f)
                close()
                moveTo(8f, 5f)
                curveTo(8f, 6.657f, 6.657f, 8f, 5f, 8f)
                verticalLineTo(12.5f)
                curveTo(5f, 13.881f, 6.119f, 15f, 7.5f, 15f)
                horizontalLineTo(9.293f)
                lineTo(8.146f, 13.854f)
                curveTo(7.951f, 13.658f, 7.951f, 13.342f, 8.146f, 13.146f)
                curveTo(8.342f, 12.951f, 8.658f, 12.951f, 8.854f, 13.146f)
                lineTo(10.854f, 15.146f)
                curveTo(11.049f, 15.342f, 11.049f, 15.658f, 10.854f, 15.854f)
                lineTo(8.854f, 17.854f)
                curveTo(8.658f, 18.049f, 8.342f, 18.049f, 8.146f, 17.854f)
                curveTo(7.951f, 17.658f, 7.951f, 17.342f, 8.146f, 17.146f)
                lineTo(9.293f, 16f)
                horizontalLineTo(7.5f)
                curveTo(5.567f, 16f, 4f, 14.433f, 4f, 12.5f)
                verticalLineTo(7.829f)
                curveTo(2.835f, 7.417f, 2f, 6.306f, 2f, 5f)
