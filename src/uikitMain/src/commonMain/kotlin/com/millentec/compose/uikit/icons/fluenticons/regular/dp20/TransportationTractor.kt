...
val FluentIcons.TransportationTractor: ImageVector
    get() {
        if (_TransportationTractor != null) {
            return _TransportationTractor!!
        }
        _TransportationTractor = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(16.656f, 8f, 17.999f, 9.343f, 17.999f, 11f)
                verticalLineTo(12f)
                curveTo(17.999f, 12.239f, 17.971f, 12.471f, 17.919f, 12.694f)
                curveTo(18.58f, 13.244f, 19f, 14.073f, 19f, 15f)
                ...
                close()
                moveTo(10.84f, 9f)
                curveTo(10.836f, 9f, 10.832f, 9f, 10.827f, 9f)
                lineTo(10.823f, 9f)
                horizontalLineTo(9f)
                curveTo(10.215f, 9.912f, 11f, 11.364f, 11f, 13f)
                curveTo(11f, 13.342f, 10.966f, 13.677f, 10.9f, 14f)
                horizontalLineTo(13.171f)
                curveTo(13.583f, 12.835f, 14.694f, 12f, 16f, 12f)
                curveTo(16.348f, 12f, 16.682f, 12.059f, 16.992f, 12.168f)
                curveTo(16.997f, 12.113f, 16.999f, 12.057f, 16.999f, 12f)
                verticalLineTo(11f)
                curveTo(16.999f, 9.895f, 16.104f, 9f, 14.999f, 9f)
...
private var _TransportationTractor: ImageVector? = null
